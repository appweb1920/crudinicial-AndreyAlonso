        ...
        <div class="col col-lg-5 col-md-12 col-sm-12">
            <div class="card" style="width: 25rem;">
                ...
                <div class="card-body card-style">
                    <h5 class="card-title">Recycling Point</h5>
                    <hr>
                    <!-- Formulario de captura RecyclingPoints -->
                    <form action="/addRecyclingPoint" method="POST">
                        <div class="form-grop">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    @csrf
                                    <input type="time" class="form-control form-control-sm " name="opening"  required/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    @csrf
                                    <input type="time" class="form-control form-control-sm " name="closing"  required/>
                                </div>
                            </div>
